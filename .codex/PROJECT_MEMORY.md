...
- Female profiles must expose women-health as a first-class profile section over the canonical `womenHealth` state; pregnancy, children/family preview, postpartum, cycle, symptom, and partner-sharing UX must not become hidden data-tab content or a second persistence system.
