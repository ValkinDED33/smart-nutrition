...
const uk = {
  ...
  "auth.creatingAccount": "Створюємо...",
  ...
  "validation.passwordMax": "Пароль має містити не більше 10 символів.",
  "validation.passwordUpper": "Додайте хоча б одну велику літеру.",
  "validation.passwordDigit": "Додайте хоча б одну цифру.",
  "validation.passwordLower": "Малі літери можна використовувати, але це не обов'язково.",
  "validation.passwordSymbol": "Спеціальний символ можна додати, але це не обов'язково.",
  ...
  "profile.dailyCalories": "Калорії",
  "profile.protein": "Білок",
  "profile.water": "Вода",
  ...
  "errorBoundary.subtitle":
    "Можна спробувати повернути екран без перезавантаження або безпечно відновити застосунок. Сесія акаунта не видаляється.",
...
const pl: Record<keyof typeof uk, string> = {
  ...
  "auth.signingIn": "Loguję...",
  "auth.creatingAccount": "Tworzę...",
  ...
  "validation.passwordMin": "Hasło musi mieć co najmniej 8 znaków.",
  "validation.passwordMax": "Hasło może mieć maksymalnie 10 znaków.",
  "validation.passwordUpper": "Dodaj przynajmniej jedną wielką literę.",
  "validation.passwordDigit": "Dodaj przynajmniej jedną cyfrę.",
  "validation.passwordLower": "Małe litery są dozwolone, ale nieobowiązkowe.",
  "validation.passwordSymbol": "Znak specjalny jest dozwolony, ale nieobowiązkowy.",
