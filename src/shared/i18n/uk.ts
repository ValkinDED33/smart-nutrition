...
export const uk = {
  ...
  "auth.registrationNote":
    "Створіть акаунт і підтвердіть email кнопкою в листі. Далі помічник м'яко проведе коротке налаштування профілю.",
  ...
  "auth.resetDeliveryUnavailable":
    "Відновлення пароля через email тимчасово недоступне. Спробуйте пізніше.",
  ...
  "auth.weakResetPassword":
    "Пароль має містити 8-10 символів, велику літеру та цифру. Спеціальні символи можна використовувати.",
