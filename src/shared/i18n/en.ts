...
export const en = {
  ...
  "auth.weakResetPassword":
    "Password must be 8 to 10 characters and include an uppercase letter and a digit. Special characters are allowed.",
  ...
  "validation.passwordMax": "Password must contain no more than 10 characters.",
  "validation.passwordUpper": "Add at least one uppercase letter.",
  "validation.passwordLower": "Lowercase letters are allowed, but not required.",
  "validation.passwordDigit": "Add at least one digit.",
  "validation.passwordSymbol": "A special character is allowed, but not required.",
