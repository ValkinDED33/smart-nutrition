...
const catalog: CatalogProductRecord[] = [
  ...
  createProduct({
    id: "manual-omelette-home",
    name: "Homemade omelette",
    calories: 154,
    protein: 11,
    fat: 11,
    carbs: 2.5,
    imageUrl: images.eggs,
    brand: "Homemade",
    aliases: ["omelette", "omelet", "омлет", "яичный омлет", "омлет з яйцем", "omlet"],
    facts: {
      foodGroup: "homemade",
      proteinTypes: ["animal", "complete"],
      fatTypes: ["saturated", "unsaturated"],
  ...
  createProduct({
    id: "manual-chicken-pilaf-home",
    name: "Homemade chicken pilaf",
    calories: 176,
    protein: 9,
    fat: 6,
    carbs: 22,
    imageUrl: images.grains,
    brand: "Homemade",
    aliases: ["pilaf", "plov", "плов", "плов с курицей", "рис с курицей", "pilaw"],
    facts: {
      foodGroup: "homemade",
      proteinTypes: ["animal", "complete"],
      carbohydrateTypes: ["complex"],
  ...
  createProduct({
    id: "manual-chicken-cutlet-home",
    name: "Homemade chicken cutlet",
    calories: 189,
    protein: 18,
    fat: 10,
    carbs: 7,
    imageUrl: images.chicken,
    brand: "Homemade",
    aliases: ["cutlet", "chicken cutlet", "котлета", "куриная котлета", "куряча котлета", "kotlet"],
    facts: {
      foodGroup: "homemade",
      proteinTypes: ["animal", "complete"],
      carbohydrateTypes: ["complex"],
  ...
  createProduct({
    id: "manual-vegetable-stew-home",
    name: "Homemade vegetable stew",
    calories: 76,
    protein: 2.4,
    fat: 3.2,
    carbs: 10,
    imageUrl: images.vegetables,
    brand: "Homemade",
    aliases: ["stew", "vegetable stew", "рагу", "овощное рагу", "овочеве рагу", "leczo"],
    facts: {
      foodGroup: "homemade",
      carbohydrateTypes: ["fiber", "complex"],
      fatTypes: ["unsaturated"],
      extraCompounds: ["phytonutrients"],
    },
  }),
  createProduct({
    id: "manual-pasta-bolognese-home",
...
const localizedAliasesById: Record<string, string[]> = {
  ...
  "manual-caesar-salad-restaurant": ["салат цезар", "цезар з куркою", "sałatka cezar"],
  "manual-shawarma-bowl": ["шаурма", "шаверма", "кебаб", "kebab box"],
  "manual-pizza-margherita": ["піца", "пицца", "pizza"],
  "manual-sushi-set": ["суші", "суши", "роли", "роллы"],
  "manual-burger-chicken": ["бургер", "курячий бургер", "chicken burger"],
  "manual-borscht-home": ["борщ", "домашній борщ", "домашний борщ", "barszcz"],
  "manual-chicken-soup-home": ["курячий суп", "куриный суп", "суп", "rosół"],
  "manual-syrniki-home": ["сирники", "сырники", "placuszki twarogowe"],
  "manual-greek-salad-home": ["грецький салат", "греческий салат", "sałatka grecka"],
  "manual-omelette-home": ["омлет", "яєчний омлет", "яичный омлет", "omlet"],
  "manual-chicken-pilaf-home": ["плов", "плов з куркою", "плов с курицей", "pilaw"],
  "manual-chicken-cutlet-home": ["куряча котлета", "куриная котлета", "котлета", "kotlet"],
  "manual-vegetable-stew-home": ["овочеве рагу", "овощное рагу", "рагу", "leczo"],
