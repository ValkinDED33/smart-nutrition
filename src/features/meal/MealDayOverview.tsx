...
const overviewCopy = {
  uk: {
    ...
    confirmedEdit: "Запис оновлено і підтверджено хмарою.",
    confirmedDelete: "Запис видалено і підтверджено хмарою.",
    confirmedRepeat: "Вчорашній прийом додано до сьогодні і підтверджено хмарою.",
  ...
  pl: {
    ...
    confirmedEdit: "Wpis zaktualizowany i potwierdzony w chmurze.",
    confirmedDelete: "Wpis usunięty i potwierdzony w chmurze.",
    confirmedRepeat: "Wczorajszy posiłek dodany do dziś i potwierdzony w chmurze.",
  ...
  en: {
    ...
    confirmedEdit: "Entry updated and confirmed in the cloud.",
    confirmedDelete: "Entry deleted and confirmed in the cloud.",
    confirmedRepeat: "Yesterday's meal was added to today and confirmed in the cloud.",
