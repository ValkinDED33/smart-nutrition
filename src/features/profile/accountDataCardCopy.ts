export const accountCopy = {
  uk: {
    ...
    securityRemote: "Вхід захищено хмарною перевіркою.",
  ...
  pl: {
    ...
    securityRemote: "Logowanie jest chronione weryfikacją w chmurze.",
  ...
  en: {
    ...
    securityRemote:
      "Sign-in is protected by cloud verification.",
