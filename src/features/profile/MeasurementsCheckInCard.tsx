...
const checkInCopy = {
  uk: {
    ...
    nextInDays: "Наступний запис через {days} дн.",
    ...
    empty: "Ще немає щотижневих записів.",
  ...
  pl: {
    ...
    nextInDays: "Kolejny zapis za {days} dni.",
    lastCheckIn: "Ostatni zapis",
    submit: "Zapisz pomiar",
    saving: "Zapisuję...",
    waist: "Talia (cm)",
    abdomen: "Brzuch (cm)",
    hip: "Biodra (cm)",
    ...
    empty: "Brak zapisanych tygodniowych pomiarów.",
