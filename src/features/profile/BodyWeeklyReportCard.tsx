...
const bodyReportCopy = {
  uk: {
    ...
    subtitle: "Вага, BMI, заміри тіла і сигнал стабілізації в одному тижневому підсумку.",
    weight: "Вага",
    bmi: "BMI",
    waist: "Талія",
    abdomen: "Живіт",
    ...
    chest: "Груди",
    checkIns: "Записи",
    plateauTitle: "AI-сигнал стабілізації ваги",
    ...
    empty: "Додайте хоча б один щотижневий запис, щоб відкрити звіт тіла.",
  ...
  pl: {
    title: "Tygodniowy raport ciała",
    subtitle: "Waga, BMI, pomiary ciała i sygnał stabilizacji w jednym tygodniowym podsumowaniu.",
    weight: "Waga",
    bmi: "BMI",
    waist: "Talia",
    abdomen: "Brzuch",
    ...
    chest: "Klatka",
    checkIns: "Zapisy",
    plateauTitle: "AI-sygnał stabilizacji wagi",
    personalTitle: "Osobisty kierunek asystenta",
    ...
    empty: "Dodaj przynajmniej jeden tygodniowy zapis, aby odblokować raport ciała.",
