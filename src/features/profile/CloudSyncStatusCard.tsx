...
const syncStatusCopy = {
  ...
  pl: {
    ...
    retryAction: "Powtórz synchronizację",
    syncingAction: "Synchronizuję...",
    syncNowAction: "Synchronizuj teraz",
    pullLatestAction: "Użyj wersji z chmury",
    pullShadowAction: "Pobierz najnowsze dane",
    writerLabel: "Ostatni zapis do chmury",
    writerCurrent: "To urządzenie",
    writerOther: "Inne urządzenie",
    writerUnknown: "Nieznane",
    pendingChangesLabel: "Zmiany oczekują na potwierdzenie",
