...
const aiCopy = {
  uk: {
    ...
    renderModeTitle: "Стиль присутності",
    renderMode2d: "Легкий образ",
    renderMode3d: "Живий образ",
    renderModeHint:
      "Живий образ вмикається тільки за вашим вибором. На телефонах і слабших пристроях помічник сам лишається легким, щоб усе працювало плавно.",
    renderModeLoading: "Готую живий образ",
  ...
  pl: {
    ...
    renderModeTitle: "Styl obecności",
    renderMode2d: "Lekki wygląd",
    renderMode3d: "Żywy wygląd",
    renderModeHint:
      "Żywy wygląd włącza się tylko po Twoim wyborze. Na telefonach i słabszych urządzeniach asystent sam zostaje lekki, żeby wszystko działało płynnie.",
    renderModeLoading: "Przygotowuję żywy wygląd",
  ...
  en: {
    ...
    renderModeTitle: "Presence style",
    renderMode2d: "Light look",
    renderMode3d: "Living look",
    renderModeHint:
      "The living look turns on only when you choose it. On phones and lighter devices the assistant stays light so the page remains smooth.",
    renderModeLoading: "Preparing living look",
