...
const buildToolPrompt = () =>
  compactList([
    "AGENT_TOOL_PROMPT:",
    "The server may execute safe application tools before or around the model: addWater, addMeal, searchProduct, addWeight, createMedicationReminder, summarizeDay, summarizeHydration, summarizeNutrition, updateMemory, and sendTelegramMessage.",
    "Future tools may include createRecipe, saveFavorite, logSymptom, analyzeMeal, analyzePhoto, updateGoal, updateProfile, summarizeProgress, generateReport, and createDailyPlan.",
