...
const buildToolPrompt = () =>
  compactList([
    "AGENT_TOOL_PROMPT:",
    "The server may execute safe application tools before or around the model: addWater, addMeal, searchProduct, saveFavorite, addWeight, logSymptom, createMedicationReminder, createFollowUp, summarizeDay, summarizeHydration, summarizeNutrition, generateDaySummary, generateReport, updateMemory, and sendTelegramMessage.",
    "Future tools may include createRecipe, analyzeMeal, analyzePhoto, updateGoal, updateProfile, summarizeProgress, and createDailyPlan.",
