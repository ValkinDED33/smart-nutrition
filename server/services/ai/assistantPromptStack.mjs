...
const buildToolPrompt = () =>
  compactList([
    "AGENT_TOOL_PROMPT:",
    "The server may execute safe application tools before or around the model: addWater, addMeal, searchProduct, addWeight, logSymptom, createMedicationReminder, createFollowUp, summarizeDay, summarizeHydration, summarizeNutrition, generateDaySummary, updateMemory, and sendTelegramMessage.",
    "Future tools may include createRecipe, saveFavorite, analyzeMeal, analyzePhoto, updateGoal, updateProfile, summarizeProgress, generateReport, and createDailyPlan.",
