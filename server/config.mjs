...
const SECRET_FILE_ENV_NAMES = [
  ...
  "SMART_NUTRITION_TELEGRAM_ASSISTANT_STICKER_REMINDER",
  ...
  "SMART_NUTRITION_TELEGRAM_ASSISTANT_ANIMATION_REMINDER",
...
const readTelegramAssistantMedia = (env) => {
  const moods = ["GREETING", "THINKING", "SUCCESS", "ERROR", "REMINDER"];
